...
class Main(Login, Admin, User):
    ...
    def __init__(self):
        ...
        self.main_window = Toplevel(bg="#B0C4FC")
        self.main_window.state('zoomed')
        self.main_window.iconbitmap("images/icon.ico")
        self.main_window.title("Asset Management")
    ...
    def buildmain(self):
        ...
        canvas_top = Canvas(self.main_window, width=700, height=70, highlightthickness=2)
        image = Image.open("images/asset.png")
        ...
        title = Label(canvas_top, text="Asset Management", bg="#B0C4FC", font=('Century', 30, 'normal'))
